    ...
    private function settingsSchema(): array
    {
        return [
            'qualification_thresholds' => [
                'label' => 'آستانه‌های پاداش ماهانه (امتیاز)',
                'hint' => 'هر درگاه موفق = ۱۰۰ امتیاز. شمارش ماهانه از صفر شروع می‌شود. با رسیدن به حد نصاب، درگاه‌های همان ماه برای همیشه واجد شرایط پاداش می‌مانند. مابقی پاداش پرداخت‌نشده به مدیر ارشد می‌رود.',
                'groups' => [
                    [
                        'label' => 'نماینده',
                        'fields' => [
                            ['key' => 'representative_points', 'label' => 'حداقل امتیاز ماهانه نماینده', 'hint' => 'پیش‌فرض ۱۰۰۰ امتیاز = ۱۰ درگاه', 'type' => 'number'],
                        ],
                    ],
                    [
                        'label' => 'مدیر فروش',
                        'fields' => [
                            ['key' => 'sales_manager_points', 'label' => 'حداقل امتیاز ماهانه مدیر فروش', 'hint' => 'پیش‌فرض ۵۰۰۰ امتیاز = ۵۰ درگاه (خود + زیرمجموعه)', 'type' => 'number'],
                        ],
                    ],
                    [
                        'label' => 'مدیر توسعه',
                        'fields' => [
                            ['key' => 'development_manager_points', 'label' => 'حداقل امتیاز ماهانه مدیر توسعه', 'hint' => 'پیش‌فرض ۲۰۰۰۰ امتیاز = ۲۰۰ درگاه (خود + زیرمجموعه)', 'type' => 'number'],
                        ],
                    ],
                ],
            ],
