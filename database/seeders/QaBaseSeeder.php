...
/**
 * Roles / rules / settings only — no FullDemoOrg (for mega QA world).
 */
class QaBaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $su = User::query()->create([
            'name' => 'سوپریوزر QA',
            'mobile' => '09120000000',
            'email' => 'super@finopal.qa',
            'password' => Hash::make((string) config('qa.password', 'Password123!')),
            'is_active' => true,
        ]);
